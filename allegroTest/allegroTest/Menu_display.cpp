...
void Menu_display::update()
{
	...
	if (m_homeScreenOption == 1) c1R = c1G = c1B = 190;
	if (m_homeScreenOption == 2) c2R = c2G = c2B = 190;
	if (m_homeScreenOption == 3) c3R = c3G = c3B = 190;
	if (m_homeScreenOption == 4) c4R = c4G = c4B = 190;
